...
from useraccount.views import MasterUserAccountViewSet
...
urlpatterns = [
    ...
    path('api/', include('exam_api.urls', namespace='exam_api')),
    path('api/user/', include('useraccount.urls', namespace='useraccount')),
    ...
    path('api/schema/doc/', schema_view.with_ui('redoc', cache_timeout=0), name='schema-redoc'),
